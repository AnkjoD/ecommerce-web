...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('pending', 'confirmed', 'processing', 'shipping', 'delivered', 'cancelled', 'payment_failed');
...
-- CreateIndex
CREATE INDEX "refresh_tokens_expires_at_idx" ON "refresh_tokens"("expires_at") WHERE ("is_revoked" = false);

-- CreateIndex
CREATE INDEX "addresses_user_id_idx" ON "addresses"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "addresses_user_id_key" ON "addresses"("user_id") WHERE ("is_default" = true);
...
-- CreateIndex
CREATE INDEX "product_variants_price_idx" ON "product_variants"("price") WHERE ("is_active" = true);
...
-- CreateIndex
CREATE UNIQUE INDEX "orders_ghtk_label_key" ON "orders"("ghtk_label");
